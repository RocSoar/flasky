...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_valid_confirmation_token(self):
        ...
        self.assertTrue(u.validate_token(token))
    ...
    def test_invalid_confirmation_token(self):
        ...
        self.assertFalse(u2.validate_token(token))
    ...
    def test_expired_confirmation_token(self):
        ...
        time.sleep(2)
        self.assertFalse(u.validate_token(token))
    ...
    def test_gravatar(self):
        ...
        self.assertTrue(
            "https://gravatar.loli.net/avatar/" + "d4c74594d841139328695756648b6bd6"
            in gravatar
        )
